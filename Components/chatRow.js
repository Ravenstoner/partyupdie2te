...
export default class chatRow extends Component {
    ...
    render() {
        return (
                <View style={{height: SCREEN_HEIGHT / 10, width: SCREEN_WIDTH - 32, paddingBottom: 10, marginBottom: 10, borderBottomColor: 'rgba(244, 244, 244, .1)', borderBottomWidth: 1, marginLeft: 16, marginRight: 16}}>
                    <View style={{flexDirection: 'row', height: '100%', width: SCREEN_WIDTH - 32, alignItems: 'center'}}>
